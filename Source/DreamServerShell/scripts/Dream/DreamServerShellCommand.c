...
class TDreamServerShellCommand: Managed
{
	...
	void SendNotify(string message, float duration = 10, string icon = ICON_GEAR)
	{
	...
	void SendNotifyToPlayer(PlayerBase player, string message, float duration = 10, string icon = ICON_GEAR)
	{
